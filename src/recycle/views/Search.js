...
const Search = ({ dispatch }) => {
    ...
    const onError = err => {
        // document.getElementById('root').innerHTML = `ERROR(${err.code}): ${err.message}`
        ...
        <section className="search">
            ...
            <div className="places_wrapper">
                {navigator.geolocation ? // if geolocation is supported on device
                    <div className="btn" onClick={hadleGetGeoLocation}>
                        <svg style={{ padding: "15px", fill: "var(--title)", fillOpacity: "0.35" }} width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
